...
const categories: Record<string, string[]> = {
  'Plaćanje javnih usluga': ['Porezi', 'Komunalne takse', 'Kazne'],
};

const QueuePaying: React.FC = () => {
    ...
    const fetchAppointments = async () => {
      try {
        ...
        const filteredAppointments = response.filter((appointment: any) =>
          categories['Plaćanje javnih usluga'].includes(
  ...
  const groupedAppointments = categories['Plaćanje javnih usluga'].reduce(
    (acc, serviceSubType) => {
